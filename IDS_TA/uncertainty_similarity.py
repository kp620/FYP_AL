...
def cal_uncertainties(model, unlabel_loader, device, dtype, classifer):
    uncertainties = []
    model.eval()
    classifer.eval()
...
def continuous_states(eigenv, label_loader, unlabel_loader, model, device, dtype, alpha, sigma, classifer):
    uncertainties = cal_uncertainties(model, unlabel_loader, device, dtype, classifer)
